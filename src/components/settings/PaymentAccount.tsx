      ...
      {currentStep !== "connected" ? (
        <>
          ...
          {currentStep === "selection" && (
            <PathSelection onSelect={handleSelection} />
          )}

          {currentStep === "create" && (
            <CreateAccount onBack={handleBack} onConnect={handleConnect} />
          )}

          {currentStep === "connect" && (
            <ConnectExisting onBack={handleBack} onConnect={handleConnect} />
          )}
        </>
      ) : (
        <ConnectedState
