      ...
      <div className="mb-6">
        <div className="grid gap-8 md:grid-cols-2">
          <button
            ...
            className="group relative overflow-hidden rounded-xl border-2 border-border bg-card p-6 text-left transition-all hover:scale-[1.02] hover:border-accent hover:shadow-lg active:scale-[0.98]"
          >
